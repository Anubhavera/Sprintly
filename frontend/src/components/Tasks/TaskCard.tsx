...
export function TaskCard({ task, onClick, isDragging, onDragStart, onDragEnd }: TaskCardProps) {
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="group relative glass-card p-5 cursor-grab overflow-hidden bg-white border-transparent hover:border-emerald-200"
      >
        {/* Spotlight Effect */}
        <motion.div
